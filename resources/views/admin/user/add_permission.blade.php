...
<div class="form-group">     
    ...
    <select id="choices-multiple-remove-button" name="add_permission" placeholder="Select Permission" multiple>

      @foreach($permissions_users as $permissions_user)
        <option value="{{$permissions_user->id}}">{{$permissions_user->name}}</option>
